        ...
        if(!args[1]){
            ...
            switch(args[1]){
                ...
                case 'listanegra':
                    ...
                    .addField("<usuário>", "Usuário a ser adicionado ou removido da lista negra ex: @Usuario");
                    msg.author.send(commandEmbed);
                    break;
                case 'cooldown':
                    commandEmbed
                    ...
                    .addField("<tempo>", "Tempo, em segundos, de cooldown do bot (valores entre 0-300)")
